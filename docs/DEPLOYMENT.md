...
- Lambda Function URL CORS allows `https://rootcawsllc.github.io`, `https://d1oxsqx3ua8bb7.cloudfront.net`, and local development origins.
...
2. Create the role, substituting your account ID into both policy files:
   ...
   `repo:RootCawsLLC/u-dont-grc-me:ref:refs/heads/main`, so no other
